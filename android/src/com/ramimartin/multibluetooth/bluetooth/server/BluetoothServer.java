...
// TODO:            EventBus.getDefault().post(new ServeurConnectionSuccess(mClientAddress));
            ...
            while(CONTINUE_READ_WRITE) {
                ...
                // TODO:              EventBus.getDefault().post(new BluetoothCommunicator(sb.toString()));

            }
        } catch (IOException e) {
            Log.e("", "ERROR : " + e.getMessage());
            // TODO:           EventBus.getDefault().post(new ServeurConnectionFail(mClientAddress));
        }
    }
