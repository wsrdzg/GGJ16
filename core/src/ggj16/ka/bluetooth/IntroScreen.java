...
public class IntroScreen extends MyScreen {
    ...
    public IntroScreen(Main main, AssetManager assetManager) {
        ...
        label.setBounds(0, Gdx.graphics.getHeight() + Gdx.graphics.getHeight() / 2f, Gdx.graphics.getWidth(), Gdx.graphics.getHeight() / 2f);
        label.addAction(Actions.moveTo(0, Gdx.graphics.getHeight() / 2f, 1f, Interpolation.bounce));
